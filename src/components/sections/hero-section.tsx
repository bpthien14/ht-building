  ...
  return (
    <section className="relative text-[#161616] overflow-hidden" style={{ fontFamily: 'var(--font-montserrat)' }}>
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 md:py-32 lg:py-48">
        <h1 
          className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black tracking-tight text-center sm:text-left"
          style={{ letterSpacing: '0.05em' }}
        >
          H&amp;T BUILDING
        </h1>
        <p 
          className="mt-3 sm:mt-4 text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-medium text-center sm:text-left"
        >
          VĂN PHÒNG CHO THUÊ <br /> TẠI LONG XUYÊN
        </p>
        <p 
          className="mt-4 sm:mt-6 max-w-full sm:max-w-xl text-base sm:text-lg md:text-xl text-[#182640]/90 font-bold text-center sm:text-left"
        >
